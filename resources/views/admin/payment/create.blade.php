            ...
            <div class="col-lg-8 offset-lg-2">
                <form action="{{ route('admin.payments.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" step="0.01" name="discount" value="{{ old('discount', 0) }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Tax</label>
                                <input class="form-control" type="number" step="0.01" name="tax" value="{{ old('tax', 0) }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Net Amount</label>
                                <input class="form-control" type="text" id="net_amount" value="0.00" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="m-t-20 text-center">
                        <button class="btn btn-primary submit-btn">Create Payment</button>
                    </div>
                </form>
            </div>
        </div>

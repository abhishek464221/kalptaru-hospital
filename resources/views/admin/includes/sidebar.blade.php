            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="{{ route('admin.schedules.index') }}"><i class="fa fa-calendar-check-o"></i> <span>Doctor Schedule</span></a>
                        </li>
                        <li>
                            <a href="{{ route('admin.departments.index') }}"><i class="fa fa-hospital-o"></i> <span>Departments</span></a>
                        </li>
						...
						<li class="submenu">
							...
							<ul style="display: none;">
								<li><a href="{{ route('admin.salary-structures.index') }}"> Employee Salary </a></li>
								<li><a href="salary-view.html"> Payslip </a></li>
							</ul>
						</li>
                        <li>
                            <a href="{{ route('admin.chats.index') }}"><i class="fa fa-comments"></i> <span>Chat</span> <span id="sidebar-chat-count" class="badge badge-pill bg-danger float-right" style="display:none"></span></a>
                        </li>
                        <li class="submenu">
                            <a href="#"><i class="fa fa-video-camera camera"></i> <span> Calls</span> <span class="menu-arrow"></span></a>
                            <ul style="display: none;">
                                <li><a href="{{ route('admin.calls.history') }}">Call Logs</a></li>
                                <li><a href="{{ route('admin.calls.create') }}">Add Call</a></li>
                                <li><a href="{{ route('admin.calls.voice') }}">Voice Call</a></li>
                                <li><a href="{{ route('admin.calls.video') }}">Video Call</a></li>
                                <li><a href="{{ route('admin.calls.incoming') }}">Incoming Call</a></li>
                            </ul>
                        </li>
                        <li class="submenu">
						...
						<li>
							<a href="{{ route('admin.activities.index') }}"><i class="fa fa-bell-o"></i> <span>Activities</span></a>
						</li>
						<li class="submenu">
                        ...
                        <li>
                            <a href="{{ route('admin.settings.index') }}"><i class="fa fa-cog"></i> <span>Settings</span></a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route('admin.calendars.index') }}"><i class="fa fa-calendar"></i> <span>Calendar</span></a>
                        </li>

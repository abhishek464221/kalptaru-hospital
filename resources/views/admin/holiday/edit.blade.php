            ...
            <div class="col-lg-8 offset-lg-2">
                <form action="{{ route('admin.holidays.update', $holiday) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="name" value="{{ old('name', $holiday->name) }}" required>
                        @error('name')<span class="text-danger">{{ $message }}</span>@enderror
                    </div>
                    <div class="form-group">
                        <label>Date <span class="text-danger">*</span></label>
                        <input class="form-control" type="date" name="holiday_date" value="{{ old('holiday_date', $holiday->holiday_date->format('Y-m-d')) }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="is_weekly_off" id="weekly_off" value="1" {{ old('is_weekly_off', $holiday->is_weekly_off) ? 'checked' : '' }}>

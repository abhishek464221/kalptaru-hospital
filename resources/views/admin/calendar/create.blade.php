                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="color">
                                    ...
                                    <option value="#FF0000" {{ old('color') == '#FF0000' ? 'selected' : '' }}>Red</option>
                                    <option value="#00FF00" {{ old('color') == '#00FF00' ? 'selected' : '' }}>Green</option>
                                    <option value="#0000FF" {{ old('color') == '#0000FF' ? 'selected' : '' }}>Blue</option>
                                    <option value="#FFFF00" {{ old('color') == '#FFFF00' ? 'selected' : '' }}>Yellow</option>
                                    <option value="#FF00FF" {{ old('color') == '#FF00FF' ? 'selected' : '' }}>Pink</option>
                                    <option value="#00FFFF" {{ old('color') == '#00FFFF' ? 'selected' : '' }}>Cyan</option>
                                    <option value="#FFA500" {{ old('color') == '#FFA500' ? 'selected' : '' }}>Orange</option>
                                    <option value="#800080" {{ old('color') == '#800080' ? 'selected' : '' }}>Purple</option>
                                    <option value="#808080" {{ old('color') == '#808080' ? 'selected' : '' }}>Gray</option>
                                    <option value="#000000" {{ old('color') == '#000000' ? 'selected' : '' }}>Black</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="location" value="{{ old('location') }}" placeholder="e.g. Conference Room A">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">

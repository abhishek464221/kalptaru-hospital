    ...
    <div class="content">
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <h4 class="page-title">Add Leave Request</h4>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <form action="{{ route('admin.leaves.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="rejection_reason" rows="2">{{ old('rejection_reason') }}</textarea>
                    </div>
                    <div class="m-t-20 text-center">
                        <button class="btn btn-primary submit-btn">Create Leave Request</button>
                    </div>
                </form>
            </div>
        </div>
